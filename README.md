...
<section align="center">
    ...
    <ol>
        ...
        <li>
            ...
            <code>
                PORT=8000
                POSTGRES_CONNECTION_STRING='postgresql://<span color="blue">username</span>:<span color="red">password</span>@localhost:5432/<span color="green">express-typescript'</span>
            </code>
        </li>
        <li>
